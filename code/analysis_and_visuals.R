...
# pull data
gss = read_csv("~/Documents/DsciInstitute/FinalProj/GSS_categoricals.csv")

# Data manipulation------------------------------------------------------

# isolate variables of choice
gss_jg = gss[,c("Respondent id number", "Hours per day watching tv", "Highest year of school completed", "Diploma, ged, or other", "Labor force status", "Respondents income")]
